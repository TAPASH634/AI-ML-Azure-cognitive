...
PREDICTION_URL = "https://mouldcrab-prediction.cognitiveservices.azure.com/customvision/v3.0/Prediction/a04deb1a-d466-40d6-b3f3-856a5dabb366/detect/iterations/Iteration1/image"
KEY = "8HQaNT1YMyOR8k9OUTpOrvQFy40W9hRmxwHl4lDq3aOkLgeslOKuJQQJ99AKACGhslBXJ3w3AAAIACOGQivr"
    ...
    if response.status_code == 200:
        ...
        for prediction in predictions:
            ...
            if probability > 0.99:
                ...
                plt.text(left, top - 10, f"Moulting , Probability : {probability}",
...
if __name__ == "__main__":
    ...
    video_path = "/home/jyoti/Documents/mudcrab_detection/crab_vdo_4.mp4"
    output_folder = "/home/jyoti/Documents/mudcrab_detection/mud crab moulting/Detected_crab_molt_test_12"
